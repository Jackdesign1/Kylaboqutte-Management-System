...
public class Laporan_Pemesanan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pn_pilihLaporan.add(pn_perTransaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 274, 180));

        t_id.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N

        btn_pilih1.setBackground(new java.awt.Color(175, 99, 154));
        btn_pilih1.setText("...");
        ...
        jLabel5.setText("Pilih Distributor");

        btnCetakPerDistributor.setBackground(new java.awt.Color(175, 99, 154));
