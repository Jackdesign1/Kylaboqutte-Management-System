...
public class Data_Barang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(175, 99, 154));
    ...
    private void pencarian() {
        List<Model_Barang> list = servis.pencarian(txtSearch.getText());
    ...
    private void pilihData() {
        ...
        model.setKode_barang(tblData.getModel().getValueAt(row, 1).toString());
        model.setNama_barang(tblData.getModel().getValueAt(row, 4).toString());
        model.setSatuan(tblData.getModel().getValueAt(row, 5).toString());
        model.setHarga(Long.parseLong(tblData.getModel().getValueAt(row, 6).toString()));
        model.setStok(Integer.parseInt(tblData.getModel().getValueAt(row, 7).toString()));
