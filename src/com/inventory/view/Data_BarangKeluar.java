...
public class Data_BarangKeluar extends javax.swing.JDialog {
    ...
    public Model_BarangKeluar psn = new Model_BarangKeluar();
    ...
    private void pencarian() {
        List<Model_BarangKeluar> list = servis.pencarian(txtSearch.getText());
    ...
    private void pilihData() {
        ...
        psn.setNo_keluar        (tblData.getModel().getValueAt(row, 1).toString());
        psn.setTgl_keluar        (tblData.getModel().getValueAt(row, 2).toString());
        psn.setTotal_keluar      (Long.parseLong(tblData.getModel().getValueAt(row, 3).toString()));
